...
SHEET_ID = "1xP8p5fxymqr2qTTK6vxp064kfPogT9F4hO6478oNJF0"
...
WEB_APP_URL = "https://docs.google.com/spreadsheets/d/1xP8p5fxymqr2qTTK6vxp064kfPogT9F4hO6478oNJF0/edit?usp=sharing"
...
with st.sidebar:
    try:
        st.image("pu-logo.png", use_container_width=True)
    except Exception:
        try:
            st.image("pu-logo.png", use_container_width=True)
        except Exception:
